...
public class DecryptDruidSource extends DruidDataSource {
	...
	public static void main(String[] args) throws Exception {
		...
		System.out.println("decrypt" + ConfigTools.decrypt(publicKey, ConfigTools.encrypt(privateKey, username)));
		System.out.println("decrypt" + ConfigTools.decrypt(publicKey, ConfigTools.encrypt(privateKey, password)));
