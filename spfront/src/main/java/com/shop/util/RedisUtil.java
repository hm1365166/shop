...
public class RedisUtil {
	...
	static String password = "asfhhvlja#@laj&k=kashljhw32l!$%*1a";
	...
	public static <T> boolean setnx(String key, T value, int second) {
		try (Jedis jedis = getJedis()) {
			/*String type = jedis.set(key, JacksonUtil.toJson(value), "xx", "ex", second);
			System.out.println("thread" + Thread.currentThread().getName());
			System.out.println("jedis set test: set result type->" + type);*/
			...
			System.out.println("thread" + Thread.currentThread().getName());
			System.out.println("jedis set key:" + key + " set result type->" + b);
			return b;
		}
	}
